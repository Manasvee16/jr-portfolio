  ...
  const projects = [
    {
      ...
      description:
        "A Python-based game with elongation logic and collision-based termination. Features include score tracking, increasing difficulty levels, and customizable game settings.",
      icon: <Gamepad2 className="h-6 w-6" />,
      tags: ["Python", "Game Development", "OOP"],
    ...
    },
    {
      ...
      title: "Snap Stash",
      description:
        "A Chrome extension to organize and save shopping website URLs. Users can categorize their favorite products, set price alerts, and sync data across devices.",
      icon: <ShoppingBag className="h-6 w-6" />,
      tags: ["HTML", "CSS", "JavaScript", "Chrome Extension"],
      link: "https://example.com/snap-stash",
      github: "https://github.com/username/snap-stash",
    },
    {
      id: 3,
      title: "FoodSavvy",
      description:
        "A website to manage health, reduce food waste, and plan meals. Features include recipe suggestions based on available ingredients, nutritional tracking, and meal planning calendar.",
      icon: <Utensils className="h-6 w-6" />,
      tags: ["HTML", "CSS", "JavaScript", "Web Development"],
      link: "https://example.com/food-savvy",
      github: "https://github.com/username/food-savvy",
    },
  ]
